...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_email'])) {
            ...
            /* NEW PHONE INPUT */
            if (isset($this->request->post['config_first_code'])) {
            $data['config_first_code'] = $this->request->post['config_first_code'];
            } else {
            $data['config_first_code'] = $this->config->get('config_first_code');
            }

            if (isset($this->request->post['config_second_code'])) {
            $data['config_second_code'] = $this->request->post['config_second_code'];
            } else {
            $data['config_second_code'] = $this->config->get('config_second_code');
            }

            if (isset($this->request->post['config_first_phone'])) {
            $data['config_first_phone'] = $this->request->post['config_first_phone'];
            } else {
            $data['config_first_phone'] = $this->config->get('config_first_phone');
            }

            if (isset($this->request->post['config_second_phone'])) {
            $data['config_second_phone'] = $this->request->post['config_second_phone'];
            } else {
            $data['config_second_phone'] = $this->config->get('config_second_phone');
            }
            /* END OF NEW PHONE INPUT */
            /* NEW WORKTIME */

            if (isset($this->request->post['config_first_wtday'])) {
            $data['config_first_wtday'] = $this->request->post['config_first_wtday'];
            } else {
            $data['config_first_wtday'] = $this->config->get('config_first_wtday');
            }

            if (isset($this->request->post['config_second_wtday'])) {
            $data['config_second_wtday'] = $this->request->post['config_second_wtday'];
            } else {
            $data['config_second_wtday'] = $this->config->get('config_second_wtday');
            }

            if (isset($this->request->post['config_first_wttime'])) {
            $data['config_first_wttime'] = $this->request->post['config_first_wttime'];
            } else {
            $data['config_first_wttime'] = $this->config->get('config_first_wttime');
            }

            if (isset($this->request->post['config_second_wttime'])) {
            $data['config_second_wttime'] = $this->request->post['config_second_wttime'];
            } else {
            $data['config_second_wttime'] = $this->config->get('config_second_wttime');
            }
            /* END OF NEW WORKTIME */
            /* Предоставление услуг */
            if (isset($this->request->post['config_service_purposes'])) {
            $data['config_service_purposes'] = $this->request->post['config_service_purposes'];
            } else {
            $data['config_service_purposes'] = $this->config->get('config_service_purposes');
            }
