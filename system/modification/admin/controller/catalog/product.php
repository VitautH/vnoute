...
class ControllerCatalogProduct extends Controller {
    ...
    $this->model_setting_setting->editSetting('product_short_description_'.$product_id,array('product_short_description_'.$product_id => $this->request->post['short_description']));
	...
	public function edit() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_catalog_product->editProduct($this->request->get['product_id'], $this->request->post);
                ...
                $this->load->model('setting/setting');
                $this->model_setting_setting->editSetting('product_short_description_'.$this->request->get['product_id'],array('product_short_description_'.$this->request->get['product_id'] => $this->request->post['short_description']));
	...
	protected function getForm() {
        ...
        if (isset($this->request->post['short_description'])) {
            ...
            $data['short_description'] = $this->config->get('product_short_description_'.$this->request->get['product_id']);
