        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-short_description"><span data-toggle="tooltip" title="Это краткое описание будет выводиться внутри карточки товара">Краткое описание</span></label>
                <div class="col-sm-10">
                  <input type="text" name="short_description" value="<?php echo $short_description; ?>" placeholder="Краткое описание" id="input-short_description" class="form-control" />
                </div>
              </div>
