          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group required">
                ...
                <div class="col-sm-10">
                  ...
                  <?php } ?>
                    ...
                    <? /*Multiphone*/?>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-first-code">
                            Код телефона №1
                        </label>
                        <div class="col-sm-2">
                          <input type="text" name="config_first_code" value="<?php echo $config_first_code; ?>" placeholder="Код первого телефона" id="input-first-code" class="form-control" />
                      </div>
                      <label class="col-sm-2 control-label" for="input-first-phone">Номер телефона</label>
                      <div class="col-sm-6">
                          <input type="text" name="config_first_phone" value="<?php echo $config_first_phone; ?>" placeholder="Первый телефон" id="input-first-phone" class="form-control" />
                      </div>
                  </div>               

                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-second-code">Код телефона №2</label>
                    <div class="col-sm-2">
                      <input type="text" name="config_second_code" value="<?php echo $config_second_code; ?>" placeholder="Код второго телефона" id="input-second-code" class="form-control" />
                  </div>
                  <label class="col-sm-2 control-label" for="input-second-phone">Номер телефона</label>
                  <div class="col-sm-6">
                      <input type="text" name="config_second_phone" value="<?php echo $config_second_phone; ?>" placeholder="второй телефон" id="input-second-phone" class="form-control" />
                  </div>
              </div>    
              ...
              <? /* end of multiphone */ ?>
                  <? /*Multiworktime*/?>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-first-wtday">
                            Рабочие дни №1
                        </label>
                        <div class="col-sm-2">
                          <input type="text" name="config_first_wtday" value="<?php echo $config_first_wtday; ?>" placeholder="Рабочие дни №1" id="input-first-wtday" class="form-control" />
                      </div>
                      <label class="col-sm-2 control-label" for="input-first-wttime">Рабочее время №1</label>
                      <div class="col-sm-6">
                          <input type="text" name="config_first_wttime" value="<?php echo $config_first_wttime; ?>" placeholder="Рабочее время №1" id="input-first-wttime" class="form-control" />
                      </div>
                  </div>               

                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-second-wtday">Рабочие дни №2</label>
                    <div class="col-sm-2">
                      <input type="text" name="config_second_wtday" value="<?php echo $config_second_wtday; ?>" placeholder="Рабочие дни №2" id="input-second-wtday" class="form-control" />
                  </div>
                  <label class="col-sm-2 control-label" for="input-second-wttime">Рабочее время №2</label>
                  <div class="col-sm-6">
                      <input type="text" name="config_second_wttime" value="<?php echo $config_second_wttime; ?>" placeholder="Рабочее время №2" id="input-second-wttime" class="form-control" />
                  </div>
              </div>    
              ...
              <? /* Предоставление услуг */ ?>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-service-purposes">Предоставление услуг</label>
                        <div class="col-sm-10">
                          <input type="text" name="config_service_purposes" value="<?php echo $config_service_purposes; ?>" placeholder="Информация о предоставлении услуг" id="input-service-purposes" class="form-control" />
                        </div>
                    </div>    

              <? /* end of Предоставление услуг */ ?>
