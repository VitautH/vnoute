...
<div class="container">
	...
	<div id="content" class="<?php echo $content_width; ?> product_page"><?php echo $content_top; ?>
		<div class="row product-content-columns">
			...
			<!-- Content right -->
			<div class="<?php echo $content_right; ?> product_page-right" id="product">
				<div class="general_info product-info">
                    ...
                    <li><strong>Краткое описание:</strong> <?php echo $short_description; ?></li>
                
						<?php if ($reward) { ?>
						<li><strong><?php echo $text_reward; ?></strong> <?php echo $reward; ?></li>
						<?php } ?>
						<li><strong><?php echo $text_stock; ?></strong> <span class="color-word"><?php echo $stock; ?></span></li>
					</ul>
					...
					<div class="grid form-group form-quantity">
						<label class="control-label lb-number" for="input-quantity"><?php echo $entry_qty; ?></label>
						<input type="number" name="quantity" value="<?php echo $minimum; ?>" size="2" id="input-quantity" class="form-control number-inp"/>
					</div>

<script>$(window).load(function(){ $("#product [name='quantity']").attr('type','text')});</script>
				</div>
...
<!-- 						<div class="form-group">
						...
						<ul class="product-buttons">
							<li><button class="btn btn-icon" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart"></i> <span class="hidden"><?php echo $button_wishlist; ?></span></button></li>
							<li><button type="button" class="btn btn-icon" onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-exchange"></i> <span class="hidden"><?php echo $button_compare; ?></span></button></li>
						</ul>
		...
		<div id="tab-description" class="product-desc product-section">
			<h3 class="product-section_title title-st"><strong><?php echo $tab_description; ?></strong></h3>
		...
		<div id="tab-specification" class="product-spec product-section">
			<!-- <h3 class="product-section_title title-st"><?php echo $tab_attribute; ?></h3> -->
			<table class="table cart-info">
			<?php foreach ($attribute_groups as $attribute_group) { ?>
			<tbody>
				<tr>
					<th colspan="2" class="tit"><span class="tit-tb"><?php echo $attribute_group['name']; ?></span></th>
				</tr>
			</tbody>
			<tbody>
				<?php foreach ($attribute_group['attribute'] as $attribute) { ?>
				<tr>
				<td><span class="tit-tb"><?php echo $attribute['name']; ?></td>
		...
		<div id="tab-review" class="product-reviews product-section">
			<h3 class="product-section_title title-st"><strong><?php echo $tab_review; ?></strong></h3>
			<form class="form-horizontal">
				...
				<div class="product-review-form" id="reviews_form">
					<?php if ($review_guest) { ?>
						<div class="form-group required">
							<label class="control-label col-md-2 col-sm-3" for="input-name"><?php echo $entry_name; ?></label>
							<div class="col-sm-7">
								<input type="text" name="name" value="" id="input-name" class="form-control" />
							</div>
						</div>
						<div class="form-group required">
							<label class="control-label col-md-2 col-sm-3" for="input-review"><?php echo $entry_review; ?></label>
							<div class="col-sm-7">						
						...
						<div class="form-group required">
							<label class="control-label col-md-2 col-sm-3"><?php echo $entry_rating; ?></label>
							<div class="col-sm-7">
								&nbsp;&nbsp;&nbsp; <?php echo $entry_bad; ?>&nbsp;
						...
						<div class="form-group required">
							<label class="control-label col-md-2 col-sm-3" for="input-captcha"><?php echo $entry_captcha; ?></label>
							<div class="col-sm-7" >
								<input type="text" name="captcha" value="" id="input-captcha" class="form-control" />
							</div>
						</div>
						<div class="form-group">
							<div class="col-sm-7 col-md-offset-2 col-sm-offset-3"> 
