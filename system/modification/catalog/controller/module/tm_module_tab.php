...
class ControllerModuleTmModuleTab extends Controller {
	public function index($setting) {
		...
		foreach ($products as $product_id) {
            ...
            if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/tm_module_tab_new.tpl')) {
            
				
            return $this->load->view($this->config->get('config_template') . '/template/module/tm_module_tab_new.tpl', $data);
            
			} else {
				
            return $this->load->view('default/template/module/tm_module_tab_new.tpl', $data);
