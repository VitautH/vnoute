	  ...
	  <div class="row"> 
		...
		<div class="product-layout product-list col-xs-12">
		  <div class="product-thumb">
		  	...
		  	<div class="clearfix">
				<div class="article pull-left"><strong>Артикул:</strong> </div>
				<div class="rating">
					<?php for ($i = 1; $i <= 5; $i++) { ?>
...
<!-- 			  <div class="cart-button">
				...
				<div class="cart-button">
					...
					<div class="left-btns">
					<button class="btn btn-add" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><!-- <i class="fa fa-shopping-cart"></i> --> <span><?php echo $button_cart; ?></span></button>
					</div>
				</div>
