		...
		<div class="product-layout product-list col-xs-12">
			<div class="product-thumb">
				...
				<div class="cart-button">
					<button class="btn btn-add" type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-shopping-cart"></i> <span class="hidden"><?php echo $button_cart; ?></span></button>
