                    ...
                    <?php foreach ($news_list as $news_item) { ?>
                        <div class="product-layout product-list col-xs-12">
                            <div class="product-thumb">
                                ...
                                <div>
                                    <div class="caption">
                                        <div class="name name-product"><a href="<?php echo $news_item['href']; ?>"><?php echo $news_item['title']; ?></a></div>
                                        <div class="description"><?php echo $news_item['description']; ?></div>
                                        <div class="cart-button">
                                            <div class="left-btns">
                                                <button class="btn btn-add" type="button" onclick="location.href = ('<?php echo $news_item['href']; ?>');" data-toggle="tooltip" title="<?php echo $text_more; ?>">
